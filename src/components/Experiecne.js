...
function Experiecne() {
    return (
        <>
            ...
            <div className='title mt-28 md:mt-30 flex justify-center flex-col items-center mb-9'>
            ...
            <div className="maincontainer mb-14 md:mb-32 flex flex-col md:flex-row   items-center justify-center">
                ...
                <div className="1-conteiner mx-4 mb-5 flex flex-col  h-[72vh] w-[44vh] md:h-[42vh] md:w-[85vh] border-2 border-gray-300 rounded-3xl items-center justify-center shadow-lg">
                ...
                <div className="2-conteiner mx-4 mb-5 flex flex-col   h-[72vh] w-[44vh] border-2 md:h-[42vh] md:w-[85vh] border-gray-300 rounded-3xl items-center justify-center shadow-lg">
