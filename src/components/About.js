            ...
            <div className="section mt-3 flex justify-center items-center flex-col md:flex-row md:mx-20 md:mt-12 md:mb-12">
                ...
                <div className="content flex justify-center flex-col items-center">
                    ...
                    <div className="md:flex ">
                        <div className="1-containt    mx-4 mb-5 flex  h-[20vh] w-[44vh] md:h-[23vh] md:w-[50vh] border-2 border-gray-300 rounded-3xl items-center justify-center space-y-4 flex-col shadow-sm">
                        ...
                        <div className="2-containt    mx-4 mb-7  flex md:h-[23vh] md:w-[50vh] h-[20vh] w-[44vh] border-2 border-gray-300 rounded-3xl items-center justify-center space-y-4 flex-col shadow-sm">
